...
openstack_nova_quota_fixed_ips quota_fixed_ips|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of fixed IPs for the tenant
openstack_nova_quota_floating_ips quota_floating_ips|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                            |1 (float)|Current usage of floating IPs for the tenant
openstack_nova_quota_injected_file_content_bytes quota_injected_file_content_bytes|tenant="admin",type="in_use"                                                                                                                                                                                                                                              |1 (float)|Current usage of injected file content bytes for the tenant
openstack_nova_quota_injected_file_path_bytes quota_injected_file_path_bytes|tenant="admin",type="in_use"                                                                                                                                                                                                                                                    |1 (float)|Current usage of injected file path bytes for the tenant
openstack_nova_quota_injected_files quota_injected_files|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of injected files for the tenant
openstack_nova_quota_instances quota_instances|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of instances for the tenant
openstack_nova_quota_key_pairs quota_key_pairs|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of key pairs for the tenant
openstack_nova_quota_metadata_items quota_metadata_items|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of metadata items for the tenant
openstack_nova_quota_ram quota_ram|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                              |1 (float)|Current usage of RAM for the tenant
openstack_nova_quota_security_group_rules quota_security_group_rules|tenant="admin",type="in_use"                                                                                                                                                                                                                                                            |1 (float)|Current usage of security group rules for the tenant
openstack_nova_quota_security_groups quota_security_groups|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                      |1 (float)|Current usage of security groups for the tenant
openstack_nova_quota_server_group_members quota_server_group_members|tenant="admin",type="in_use"                                                                                                                                                                                                                                                            |1 (float)|Current usage of server group members for the tenant
openstack_nova_quota_server_groups quota_server_groups|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                          |1 (float)|Current usage of server groups for the tenant
...
openstack_cinder_volume_gb| region="RegionOne",availability_zone="nova",bootable="true",id="173f7b48-c4c1-4e70-9acc-086b39073506",name="test-volume",status="available",tenant="demo_with_attachment", tenant_id="bab7d5c60cd041a0a36f7c4b6e1dd978",user_id="32779452fcd34ae1a53a797ac8a1e064",volume_type="lvmdriver-1",server_id="f4fda93b-06e0-4743-8117-bc8bcecd651b"        |4.0 (float)
...
>>>>>>> efa6918bda03e22745e09e9b41e8724bfd5f2425
